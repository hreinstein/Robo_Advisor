...
from app.robo import get_response, transform_response, write_to_csv, to_usd
...
def test_write_to_csv():
    ...
    assert os.path.isfile(csv_file_path) == False # just making sure the test was setup properly
